...
public class panelInstructionTab3 extends JPanel
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.drawImage(panelForeground, 32, 85, this);  //IMG, LEFT, TOP
        
        Font f1 = new Font("Gothic", Font.BOLD, 20);
        g.setFont(f1);
        g.setColor(Color.WHITE);
        g.drawString("Game 1 @ The Scranton Campus", 30, 50);
        Font f2 = new Font("Gothic", Font.BOLD, 16);
        g.setFont(f2);
        g.drawString("Tic-Tac-Toe", 31, 67);
    }
